...
public class Emprestimo {
	...
	public Emprestimo(@NotEmpty(message = "O isbn deve ser preenchido") String isbn,
			@NotEmpty(message = "O RA deve ser preenchido") String ra, String dataEmprestimo, String dataDevolucao,
